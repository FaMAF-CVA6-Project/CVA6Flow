...
EXTERNAL_SCRIPTS = {
    ...
    "MinorFlow_tracer.py",           # the sibling viewer
    # In the CVA6 fork:
    "check_CVA6_repo.py",
    "docker_run.py",
    "make_containers.py",
...
def check_formatter():
    ...
    script = os.path.join(REPO, "scripts", "format_CVA6Flow_repo.py")
    if not os.path.isfile(script):
        return ["SKIP scripts/format_CVA6Flow_repo.py is missing"]
