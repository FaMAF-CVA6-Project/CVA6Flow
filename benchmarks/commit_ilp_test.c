/* Paired with the NrCommitPorts 2 -> 1 cut: eight independent generator
 * updates per iteration, short integer instructions the second commit port
 * can take, so one port commits the same work in more cycles. */
...
int main()
{
    ...
    // MAIN PROGRAM
    unsigned a = 1u, b = 2u, c = 3u, d = 4u, e = 5u, f = 6u, g = 7u, h = 8u;
    for (int i = 0; i < ITERS; i++)
    {
        a = a * 1103515245u + 12345u;
        b = b * 1103515245u + 54321u;
        c = c * 1103515245u + 11111u;
        d = d * 1103515245u + 22222u;
        e = e * 1103515245u + 33333u;
        f = f * 1103515245u + 44444u;
        g = g * 1103515245u + 55555u;
        h = h * 1103515245u + 66666u;
    }
